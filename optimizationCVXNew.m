function [OptOut] = optimizationCVXNew(dictResp,dictPred,trainData,optParam)
...
%     minimize(norm(trainData(1:respLength,:) - dictResp*sparseRepFullTrainDictResp,'fro') + lambdaResp*norm(sparseRepFullTrainDictResp,1) + ... 
...
cvx_begin
    ...
    minimize( gammaMapMat*norm(mapMat*sparseRepFullTrainDictPred - sparseRepFullTrainDictResp,'fro') + lambdaMapMat*norm(mapMat,'fro') );
