function [feature]=featureExtraction(dataLeadOrg,sampFreq)

len1 = length(dataLeadOrg);

pb1Filt = 0.7/(sampFreq/2);
pb2Filt = 250/(sampFreq/2);
...
QFeature = QFeatureExtraction(dataLead,sampFreq,timeAxis);
...
TFeature = TFeatureExtraction(dataLead,QFeature,sampFreq,timeAxis);
...
PFeature = PFeatureExtraction(dataLead,QFeature,TFeature,sampFreq,timeAxis);
